...
import '../features/contractors/job_screens.dart';
import '../features/customers/customer_screens.dart';
import '../features/definitions/definitions_screens.dart';
import '../features/expenses/expense_screens.dart';
import '../features/extra/estate_screens.dart';
import '../features/extra/extra_screens.dart';
import '../features/reports/pnl_screen.dart';
import '../features/shell/shell_screens.dart';
...
GoRouter createRouter(AuthBloc authBloc) {
  return GoRouter(
    ...
    redirect: (context, state) {
      ...
      if (auth is AuthInitial && !onSplash) return '/splash';
      if (auth is AuthGuest && !onLogin) return '/login';
